        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Garments_Users_OwnerId",
                        column: x => x.OwnerId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GarmentImages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GarmentImages_Garments_GarmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OwnerAcceptedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    RenterConfirmedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Rentals_Garments_GarmentId",
                        column: x => x.GarmentId,
                        principalTable: "Garments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reviews_Garments_GarmentId",
                        column: x => x.GarmentId,
                        principalTable: "Garments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GarmentImages_GarmentId_Order",
                table: "GarmentImages",
                columns: new[] { "GarmentId", "Order" });

            migrationBuilder.CreateIndex(
                name: "IX_Garments_City",
                table: "Garments",
                column: "City");

            migrationBuilder.CreateIndex(
                name: "IX_Garments_DailyPrice",
                table: "Garments",
                column: "DailyPrice");

            migrationBuilder.CreateIndex(
                name: "IX_Garments_IsAvailable",
                table: "Garments",
                column: "IsAvailable");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rentals_GarmentId_StartDate_EndDate",
                table: "Rentals",
                columns: new[] { "GarmentId", "StartDate", "EndDate" });
